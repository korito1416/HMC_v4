    ...
    def apply_symplectic_integration(self,
        ...
        for _ in range(num_steps):
            ...
            if re.match(r"\A(verlet|leapfrog)\Z", symplectic_integrator, re.IGNORECASE):
                ...
                # print(i, " current momentum", current_momentum)
                # print(i, " current momentum inverse",  self.mass_matrix_inv_matvec(current_momentum))
                ...
                # print(i, " potential energy grad", grad)

                # Update state again
                proposed_state += (0.5*h) * self.mass_matrix_inv_matvec(proposed_momentum)
                # print(i, " proposed momentum", proposed_momentum)
                # print(i, " proposed momentum inverse",  self.mass_matrix_inv_matvec(proposed_momentum))
                # print(i, " proposed state", proposed_state)
                # i+=1
